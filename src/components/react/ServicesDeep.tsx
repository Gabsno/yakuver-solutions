...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    accent: '#0891b2',
    name: 'HVAC & R Systems',
    lede: 'Heating, Ventilation, Air-Conditioning & Refrigeration — splits, ducted, VRF, chilled-water and commercial refrigeration. Sized, commissioned and maintained for West African tropical performance.',
    bullets: [
      'Cooling-load calculations and equipment selection',
      'VRF outdoor + indoor unit pairing and refnet branch design',
      'Chilled-water plant rooms with primary/secondary loops',
      'Commercial refrigeration — cold rooms, walk-ins, blast chillers',
